...
const clickArrow = (arrowNode, valSign) => {
  ...
  // arrow -> frames -> board
  const subRoot = arrowNode.parentNode.parentNode;
  const flagNode = subRoot.querySelector(".section-projects-board-flag");
  const framesImgNodes = subRoot.querySelectorAll(".section-projects-board-frames img");
...
const leftArrowNodes = document.querySelectorAll(
  ".section-projects-board-frames-left-button"
);

const rightArrowNodes = document.querySelectorAll(
  ".section-projects-board-frames-right-button"
);
...
function setBoardFrameLink(frameNode, isInsert) {
  ...
  if (frameNode) {
    ...
    else for (let node of document.querySelectorAll(".section-projects-board-frames")) {
